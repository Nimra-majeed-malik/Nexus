...
import { Menu, X, Bell, MessageCircle, User, LogOut, Building2, CircleDollarSign, Video, FileText, CreditCard, Home } from 'lucide-react';
...
export const Navbar: React.FC = () => {
  ...
  const mobileLinks = user?.role === 'entrepreneur' ? entrepreneurLinks : investorLinks;
            ...
            {user ? (
              <>
                ...
                <div className="border-t border-gray-200 pt-2">
                  {/* All links including Video, Documents, Payments */}
